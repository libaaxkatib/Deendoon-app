...
/**
 * Backend Completion Roadmap, Phase 4.3 — Subscription Lifecycle. Adds
 * `trial_expired`/`subscription_expired` (AuditAction::TrialExpired/
 * SubscriptionExpired) to the audit_log.action CHECK constraint,
 * following the same additive DROP/ADD CONSTRAINT pattern as every prior
 * expansion of this list (see
 * 2026_08_14_090000_add_subscription_audit_actions_to_audit_log_check_constraint.php).
 */
