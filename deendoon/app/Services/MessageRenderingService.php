 ...
 * sender/company name — into the selected template." Scoped to
 * Reminder-sourced rendering only, per this sprint's Reminder Center
 * scope — Document-sourced rendering (§8.8 Share) belongs to the
 * Documents module sprint.
 */
