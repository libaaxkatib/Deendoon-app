...
**Main Flow**
1. User submits customer details (name, phone number, optionally an address, and any additional fields defined in `06_Database_Design.md`), optionally including an explicit Credit Limit.
