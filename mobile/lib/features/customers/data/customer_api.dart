...
class CustomerApi {
  ...
  CustomerSaveResult _saveResultFrom(Map<String, dynamic> data) => (
        ...
        warning:
            data['warning'] != null ? DuplicateWarning.fromJson(data['warning'] as Map<String, dynamic>) : null,
      );
  ...
  Future<DuplicateWarning?> checkDuplicate({required String name, required String phone}) async {
    final response = await _dio.post('customers/check-duplicate', data: {'name': name, 'phone': phone});
    final data = response.data['data'] as Map<String, dynamic>;
    return data['warning'] != null ? DuplicateWarning.fromJson(data['warning'] as Map<String, dynamic>) : null;
  }
}
