...
final notificationRepositoryProvider =
    Provider<NotificationRepository>((ref) => NotificationRepository(ref.read(notificationApiProvider)));
...
class NotificationRepository {
  ...
  Future<NotificationPage> fetchNotifications({required int page, String? type}) =>
      _guard(() => _api.list(page: page, type: type));

  Future<NotificationPage> fetchHistory({required int page}) => _guard(() => _api.history(page: page));
