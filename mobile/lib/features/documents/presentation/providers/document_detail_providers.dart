...
final documentHistoryProvider = FutureProvider.family<List<DocumentEvent>, String>(
  (ref, documentId) => ref.watch(documentRepositoryProvider).fetchHistory(documentId),
);
