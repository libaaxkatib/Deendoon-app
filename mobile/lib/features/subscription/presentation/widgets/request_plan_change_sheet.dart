...
/// assumes one.
Future<bool?> showRequestPlanChangeSheet(
...
class _RequestPlanChangeSheet extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<_RequestPlanChangeSheet> createState() =>
      _RequestPlanChangeSheetState();
}

class _RequestPlanChangeSheetState
    extends ConsumerState<_RequestPlanChangeSheet> {
    ...
    return BottomSheetContent(
      child: Form(
        ...
        child: Column(
          ...
          children: [
            Text(
              l10n.subscriptionRequestPlanChangeSheetTitle,
              style: Theme.of(context).textTheme.titleMedium,
            ),
            const SizedBox(height: 4),
            Text(
              l10n.subscriptionRequestPlanChangeDescription(
                widget.plan.name,
