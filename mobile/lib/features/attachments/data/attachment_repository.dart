...
final attachmentRepositoryProvider =
    Provider<AttachmentRepository>((ref) => AttachmentRepository(ref.read(attachmentApiProvider)));
...
class AttachmentRepository {
  ...
  Future<List<Attachment>> fetchAttachments(String entityPathPrefix) => _guard(() => _api.list(entityPathPrefix));
