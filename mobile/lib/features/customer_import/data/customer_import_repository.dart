...
final customerImportRepositoryProvider = Provider<CustomerImportRepository>(
  (ref) => CustomerImportRepository(ref.read(customerImportApiProvider)),
);
...
class CustomerImportRepository {
  ...
  Future<ImportCommitResult> commitImport({required String batchId}) =>
      _guard(() => _api.commit(batchId: batchId));
