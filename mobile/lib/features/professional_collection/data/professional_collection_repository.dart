...
class ProfessionalCollectionRepository {
  ...
  Future<ProfessionalCollectionSummary> fetchSummary() => _guard(() => _api.summary());
  ...
  Future<List<DocumentSummary>> fetchDocuments(String id) => _guard(() => _api.documents(id));

  Future<List<ProfessionalCollectionAttachment>> fetchAttachments(String id) => _guard(() => _api.attachments(id));
  ...
  Future<ProfessionalCollectionAttachment> uploadAttachment({
    ...
    required String fileName,
      ...
      _guard(() => _api.uploadAttachment(id: id, filePath: filePath, fileName: fileName));

  Future<List<ProfessionalCollectionTimelineEvent>> fetchTimeline(String id) => _guard(() => _api.timeline(id));
