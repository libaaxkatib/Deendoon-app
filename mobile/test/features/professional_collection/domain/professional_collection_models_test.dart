...
void main() {
  ...
  test('ProfessionalCollectionRequest defaults reasons/requestedServices to empty when absent', () {
    final request = ProfessionalCollectionRequest.fromJson({
      'id': '1',
      'collection_case_id': '01CASE',
      'reference_number': 'PCR-0001',
  ...
  test('ProfessionalCollectionSummary parses the exact summary() shape, including a null latest_request', () {
  ...
  test('ProfessionalCollectionSummary parses a real latest_request and latest_timeline_event', () {
    final summary = ProfessionalCollectionSummary.fromJson({
      'counts_by_status': {
        'submitted': 1,
        'under_review': 0,
