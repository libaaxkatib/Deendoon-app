...
void main() {
  ...
  test(
    'fetchBusinessHealth returns the value straight through on success',
    () async {
  ...
  test(
    'fetchBusinessHealth throws ApiException with the server message on failure',
    () async {
  ...
  test('fetchKpis returns the value straight through on success', () async {
    when(
      () => mockApi.kpis(period: 'month', dateFrom: null, dateTo: null),
  ...
  test(
    'fetchKpis throws ApiException with the server message on failure',
    () async {
      when(
        () => mockApi.kpis(period: 'month', dateFrom: null, dateTo: null),
      ).thenThrow(
  ...
  test(
    'fetchRecentCases passes the limit through and translates failures independently',
    () async {
