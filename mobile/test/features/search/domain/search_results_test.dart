...
void main() {
  test(
    'parses every entity type present in the real SearchController response',
    () {
  ...
  test(
    'a null category means the role cannot view that entity, not "no matches"',
    () {
      final results = SearchResults.fromJson({
        'customers': null,
        'debts': null,
  ...
  test(
    'an empty list means the role can view the entity but nothing matched',
    () {
      final results = SearchResults.fromJson({
        'customers': [],
        'debts': null,
