...
void main() {
  group('CollectionCase', () {
    test('parses the exact CollectionCaseResource shape', () {
      final collectionCase = CollectionCase.fromJson(
        _caseJson(assignedOfficerUserId: '01OFFICER'),
      );
    ...
    test(
      'parses a null assigned_officer_user_id (no officer assigned yet)',
      () {
    ...
    test('parses a real notes value', () {
      final collectionCase = CollectionCase.fromJson(
        _caseJson(notes: 'Called customer, promised payment next week.'),
      );
    ...
    test('parses a closed case with a closure outcome', () {
      final collectionCase = CollectionCase.fromJson(
        _caseJson(caseStatus: 'closed', closureOutcome: 'Paid in full'),
      );
  ...
  group('CollectionCasePage', () {
    test(
      'parses the collection_cases + pagination envelope from GET /collection-cases',
      () {
