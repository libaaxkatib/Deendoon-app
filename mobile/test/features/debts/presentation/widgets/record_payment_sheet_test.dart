...
const _payment = Payment(id: '01PAY', debtId: '1', amount: '250.00', paymentDate: '2026-08-01', paymentMethod: 'Cash');
...
void main() {
  ...
  testWidgets('submits amount, method, and notes to the real endpoint', (tester) async {
    when(() => mockRepository.recordPayment(
          debtId: '1',
          amount: '250.00',
    ...
    await tester.enterText(find.widgetWithText(TextFormField, 'Amount'), '250.00');
    await tester.enterText(find.widgetWithText(TextFormField, 'Payment Method (optional)'), 'Cash');
    await tester.enterText(find.widgetWithText(TextFormField, 'Notes (optional)'), 'Partial settlement');

    await tester.tap(find.widgetWithText(ElevatedButton, 'Save Payment'));
    await tester.pumpAndSettle();

    verify(() => mockRepository.recordPayment(
          debtId: '1',
          amount: '250.00',
          paymentDate: any(named: 'paymentDate'),
          paymentMethod: 'Cash',
